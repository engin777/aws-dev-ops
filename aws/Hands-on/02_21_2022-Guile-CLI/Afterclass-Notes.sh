...
aws s3 mb s3://engin-bucket

aws s3 cp in-class.yaml s3://engin-bucket (lokal konsolda aç, dosyanın konumuna gel)

## aws s3 ls s3://test-engin1 --recursive

aws s3 ls s3://engin-bucket

aws s3 rm s3://engin-bucket/in-class.yaml

aws s3 rm s3://bucket-name --recursive

aws s3 rb s3://engin-bucket        !!!!
aws s3 rb s3://test-engin1 --force
delete: s3://test-engin1/test22.txt
delete: s3://test-engin1/test12.txt
remove_bucket: test-engin1
